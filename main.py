...
def rules():
    ...
    purple("Your base energy level starts off as 'Neutral', while your suspicion points start off as '0'.")
    red("During the night, you have 3 options.")
    blue("1. Peek out your window\n2. Hide\n3. Go to sleep")
    red("Peeking out the window allows you to make observations (and potentially see some super suspicious stuff!!! oooo)")
    ...
    red("You must then interrogate every player - a successful interrogation may allow you to obtain valuable information.")
    blue("You will then be interrogated. Successfully winning the interrogation will cause you to look less suspicious to the others.")
    green("Afterwards, all players must vote for who they believe is the murderer.")
    yellow("Some players may find you trustworthy and follow your vote, while others may keep their votes hidden from you.")
    purple("The game ends if the murderer successfully murders everyone (1 survivor left is a win for the murderer)\nor if the survivors successfully eliminate the murderer!")
